...
class OrderList(APIView):
    ...
    def post(self, request):
        ...
        for data in request.data:
            ...
            order = Order.objects.create(user=user, product_id=product, money=money, number=number, iteam_code='10' + str(count_order).zfill(4),)
            order.save()
